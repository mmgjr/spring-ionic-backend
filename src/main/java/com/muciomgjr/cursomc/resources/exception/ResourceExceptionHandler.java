package com.muciomgjr.cursomc.resources.exception;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> Validation(
		...
		for (FieldError fail : e.getBindingResult().getFieldErrors()) {
			err.addError(fail.getField(), fail.getDefaultMessage());
		}
		return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(err);
	}	
}
